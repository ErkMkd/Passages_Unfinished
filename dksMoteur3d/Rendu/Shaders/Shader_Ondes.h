#ifndef SHADER_ONDES_H_INCLUDED
#define SHADER_ONDES_H_INCLUDED

#include "dksShader.h"

class Shader_Ondes: public dksShader
{
    public:
    ...
    //  Constructeur
    //======================================
        Shader_Ondes(char* p_nom,char* p_source_vertex,char* p_source_fragment):dksShader(p_nom,p_source_vertex,p_source_fragment)
        {
            if(erreur==DKSSHADER_OK)
            {
                ...
                if (erreur_openGl("ERREUR dans Shader_Ondes::Shader_Ondes() :"))erreur=DKSSHADER_ERREUR_VARIABLES;
            }
        }
