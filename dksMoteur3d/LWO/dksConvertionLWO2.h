...
class dksConvertionLWO2
{
    ...
    public:
        dksConvertionLWO2(dksChargeLWO2* p_donneesLWO2)
        {
            ...
            if (donneesLWO2==NULL)
            {
                cout<<"Erreur dans dksConvertionLWO2() - Données LWO2 invalides"<<endl;
            ...
            if (DKSCONVERTIONLWO2_DEBUG)
            {
                ...
                if (DKSCONVERTIONLWO2_DEBUG_DUREES) cout<<"Durée de la convertion: "<<duree_totale<<" ms"<<endl ;
    ...
    private:
        bool creation_volumes()
        {
            ...
            for (i=0;i<nbrVolumes;i++)
            {
                ...
                if (calque==NULL)
                {
                    cout<<"Erreur dans dksConvertionLWO2.creation_volumes() - Données LWO2 invalides"<<endl;
                    erreur=DKSCONVERTIONLWO2_ERREUR_LWO2_INVALIDE;
                    return false;
                }
                ...
                {
                    cout<<"Erreur dans dksConvertionLWO2.creation_volumes() - Erreur lors de la création du volume ' "<<calque->nom<<" '"<<endl;
        ...
        bool creation_sommets()
        {
            ...
            for (i=0;i<nbrVolumes;i++)
            {
                ...
                if (sommets==NULL)
                {
                    cout<<"Erreur dans dksConvertionLWO2.creation_sommets() - Mémoire insuffisante"<<endl;
                    erreur=DKSCONVERTIONLWO2_ERREUR_MEMOIRE;
                    return false;
                }
        ...
        bool creation_surfaces()
        {
            ...
            for (i=0;i<nbrSurfacesLWO2;i++)
            {
                ...
                if (surfaceLWO2==NULL)
                {
                    cout<<"Erreur dans dksConvertionLWO2.creation_surfaces() - Données LWO2 invalides"<<endl;
                    erreur=DKSCONVERTIONLWO2_ERREUR_LWO2_INVALIDE;
                    return false;
                }
                ...
                //{
                    ...
                    {
                        cout<<"Erreur dans dksConvertionLWO2.creation_surfaces() - Mémoire insuffisante"<<endl;
                        erreur=DKSCONVERTIONLWO2_ERREUR_MEMOIRE;
                        return false;
                    }
        ...
        bool creation_polygones()
        {
            ...
            for (i=0;i<nbrVolumes;i++)
            {
                ...
                if (tableFaces==NULL)
                {
                    cout<<"Erreur dans dksConvertionLWO2.creation_polygones() - Mémoire insuffisante pour allouer le tableau des faces"<<endl;
                    erreur=DKSCONVERTIONLWO2_ERREUR_MEMOIRE;
                    return false;
                }
                ...
                for (j=0;j<nbrPolygones;j++)
                {
                    ...
                    if (sommets==NULL)
                    {
                        ...
                        cout<<"Erreur dans dksConvertionLWO2.creation_polygones() - Mémoire insuffisante pour allouer le tableau des arêtes"<<endl;
                        erreur=DKSCONVERTIONLWO2_ERREUR_MEMOIRE;
                        return false;
                    }
                    ...
                    {
                        libere_table_faces_en_construction(tableFaces,nbrPolygones);
                        cout<<"Erreur dans dksConvertionLWO2.creation_polygones() - Pas de surface définie pour un polygone"<<endl;
                        erreur=DKSCONVERTIONLWO2_ERREUR_LWO2_INVALIDE;
                        return false;
                    }
                    ...
                    {
                        libere_table_faces_en_construction(tableFaces,nbrPolygones);
                        cout<<"Erreur dans dksConvertionLWO2.creation_polygones() - Impossible de créer les faces"<<endl;
                        erreur=DKSCONVERTIONLWO2_ERREUR_MEMOIRE;
                        return false;
                    }
        ...
        {
            uint32_t i,j,k;
            vector<dksSurface*> surfaces_volume; //Table de stockage des surfaces liée au volume
    ...
    public:
        ...
        dksVolume** renvoie_volumes_convertis()
        {
            if (tableau_volumes_convertis==NULL)
            {
                ...
                if (tableau_volumes_convertis==NULL)
                {
                    cout<<"ERREUR dans dksConvertionLWO2::renvoie_volumes_convertis() - mémoire insuffisante"<<endl;
                    erreur=DKSCONVERTIONLWO2_ERREUR_MEMOIRE;
                    return NULL;
                }
