...
class Courbe_Bezier_Plan
	{
		...
		double P1_x; //Position du point 1  (Contrôl de courbe au point 0)
		double P1_y;

		double P2_x; //Position du point 2 (Contrôl de courbe au point 3)
		double P2_y;
		...
		//Données pour la résolution y(x):
        double alpha;
		double beta;
		double gamma;
		double delta;
